...
public class EmailUtilities {
  ...
  public static Session getSession(Properties emailProps, String overrideEmailPW) {
    ...
    if (emailProps != null) {      
      final String fromEmail = emailProps.getProperty("emailAddress");
      final String password = (overrideEmailPW.length() > 0 ? overrideEmailPW : emailProps.getProperty("emailPassword"));  
  ...
  public static boolean sendAttachmentEmail(Session session, String fromEmail, String toEmail, 
    ...
    try {
      ...
      messageBodyPart.setFileName(fileNameAndPath);
      multipart.addBodyPart(messageBodyPart);  
